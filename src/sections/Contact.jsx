...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "er.sudhirkumarkabira@gmail.com",
    href: "mailto:er.sudhirkumarkabira@gmail.com",
  },
  {
    icon: Phone,
    label: "Phone",
    value: "+91 7986515332",
    href: "tel:+917986515332",
  },
  {
    icon: MapPin,
    label: "Location",
    value: "Padama Tawar II, Rajindar Place, New Delhi",
    href: "#",
  },
];
  ...
  return (
    <section id="contact" className="py-12 relative overflow-hidden">
      <div className="absolute top-0 left-0 w-full h-full">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-primary/5 rounded-lg blur-3xl" />
        <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-highlight/5 rounded-lg blur-3xl" />
      </div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
          <div className="glass p-8 rounded-lg border border-primary/30 animate-fade-in animation-delay-300">
          ...
          <div className="space-y-6 animate-fade-in animation-delay-400">
            ...
            <div className="glass rounded-lg p-8 border border-primary/30">
              <div className="flex items-center gap-3 mb-4">
                <span className="w-3 h-3 bg-green-500 rounded-lg animate-pulse" />
